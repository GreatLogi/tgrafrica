                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2-5 col-xl-1-5">
                            ...
                            <p class="card-big-info-desc">Add here the product description with all details and necessary
                                information.</p>
                        </div>
                        <div class="col-lg-3-5 col-xl-4-5">
                            ...
                            <div class="form-group row pb-4">
                                <label class="col-lg-5 col-xl-3 control-label text-lg-end pt-2 mt-1 mb-0">Product
                                    Description</label>
                                <div class="col-lg-7 col-xl-6">
