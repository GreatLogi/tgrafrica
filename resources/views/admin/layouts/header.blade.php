     ...
     <div class="logo-container">
         <a href="https://www.okler.net/previews/porto-admin/" class="logo">
             <img src="{{ asset('img/logo-default-slim.png') }}" class="logo-image" width="90" height="35"
                 alt="Porto Admin" />
             <img src="{{ asset('img/logo-default-slim.png') }}" class="logo-image-mobile" width="90" height="41"
                 alt="Porto Admin" />
         </a>
         ...
         <div id="userbox" class="userbox">
             ...
             <div class="dropdown-menu">
                 <ul class="list-unstyled">
                     <li>
                         <a role="menuitem" tabindex="-1" href="pages-user-profile.html"><i class="bx bx-user"></i> My
                             Profile</a>
                     </li>
                     <li>
