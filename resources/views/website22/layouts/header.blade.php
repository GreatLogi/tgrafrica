                            ...
                            <nav class="header-nav-top">
                                <ul class="nav nav-pills">
                                    <li class="nav-item nav-item-anim-icon d-none d-md-block"> <a class="nav-link ps-0"
                                            href="javascript:void(0)"><i class="fas fa-angle-right"></i>Book a Consultation</a> </li>
                            ...
                            <div
                                ...
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <li class="dropdown"> <a class="dropdown-item dropdown-toggle {{ Request::is('advisory*') ? 'active' : '' }}"
