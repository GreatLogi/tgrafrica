        ...
        <di class="col-md-6 col-sm-12 order-md-2 mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInRightShorter">
            <div id="popup" class="ipopup">
                ...
                <img class="img-fluid box-shadow-3 my-2 border-radius" src="{{ asset('img/gallery/gallery-2.png') }}"
                    href="https://a.co/d/f5xmi3p" style="height: 275px; width: 230px;" alt=""> <br>
                <a class="align-items-center" href="https://a.co/d/bg4dL5s" style="font-size: large;">Grab a copy on Amazon
                    now <span class="social-icons-amazon">
