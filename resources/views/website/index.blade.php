...
<div role="main" class="main">
    <div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover show-dots-xs nav-style-1 nav-inside nav-inside-plus nav-dark nav-lg nav-font-size-lg show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 7000}" data-dynamic-height="['650px','650px','650px','550px','500px']" style="height: 650px;">
        <div class="owl-stage-outer">
            <div class="owl-stage">
                <!-- Carousel Slide 1 -->
                <div class="owl-item position-relative" style="background-image: url(img/slides/slide-corporate-3-2.jpg); background-size: cover; background-position: center;">
                    <div class="container position-relative z-index-1 h-100">
                        <div class="row align-items-center h-100">
                            <div class="col-lg-6 text-center">
                                <div class="d-flex flex-column align-items-center justify-content-center h-100">
                                    <h3 class="position-relative text-color-white color-white text-5 line-height-5 font-weight-medium ls-0 px-4 mb-2 appear-animation" style="color: white" data-appear-animation="fadeInDownShorterPlus" data-plugin-options="{'minWindowWidth': 0}">
                                        ...
                                        A JOURNEY BACK <span class="position-relative">TO <span class="position-absolute left-50pct transform3dx-n50 top-0 mt-4"><img src="{{ asset('img/slides/slide-blue-line.png') }}" class="w-auto appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="1000" data-plugin-options="{'minWindowWidth': 0}" alt="" /></span></span>
                                    ...
                                    <h1 class="text-color-white font-weight-extra-bold text-12-5 line-height-1 mb-2 appear-animation" style="color: white" data-appear-animation="blurIn" data-appear-animation-delay="500" data-plugin-options="{'minWindowWidth': 0}">
                                        HOME & HEART</h1>
                                    <p class="text-4-5 text-color-white font-weight-light mb-0" style="color: white" data-plugin-animated-letters data-plugin-options="{'startDelay': 1000, 'minWindowWidth': 0}">welcome to The
                                        Great Return</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="owl-item position-relative overflow-hidden">
                    <div class="background-image-wrapper position-absolute top-0 left-0 right-0 bottom-0" data-appear-animation="kenBurnsToRight" data-appear-animation-duration="13s" data-plugin-options="{'minWindowWidth': 0}" data-carousel-onchange-show style="background-image: url(img/slides/slide-corporate-3-a.jpg); background-size: cover; background-position: center;">
                    </div>
                    <div class="container position-relative z-index-3 h-100">
                        <div class="row justify-content-center align-items-center h-100">
                            <div class="col-lg-7">
                                <div class="d-flex flex-column align-items-center">
                                    <h2 class="text-color-dark font-weight-extra-bold text-12-5 line-height-1 text-center mb-3 appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="500" data-plugin-options="{'minWindowWidth': 0}">HOMECOMING</h2>
                                    <p class="text-4-5 text-color-dark font-weight-light text-center mb-4" data-plugin-animated-letters data-plugin-options="{'startDelay': 1000, 'minWindowWidth': 0, 'animationSpeed': 30}">
                                        Where Every Story Begins Anew</p>
                                    <a href="#" class="btn btn-secondary btn-modern font-weight-bold text-2 py-3 btn-px-5 mt-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2500" data-plugin-options="{'minWindowWidth': 0}">DISCOVER MORE <i class="fas fa-arrow-right ms-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 pb-sm-4 pb-lg-0 pe-lg-5 mb-sm-5 mb-lg-0">
                    <h2 class="text-color-dark font-weight-normal text-6 mb-2"> We are <strong class="font-weight-extra-bold">TGR Africa</strong></h2>
                    <p class="lead pe-lg-5 me-lg-5">We are dedicated to rebuilding, reconnecting and revitalising the African diasporas relationship with Africa</p>
                    <a href="{{ route('about.mission') }}" class="btn btn-dark font-weight-semibold btn-px-4 btn-py-2 text-2">LEARN MORE</a>
                </div>
                <div class="col-sm-8 col-md-6 col-lg-4 offset-sm-4 offset-md-4 offset-lg-2 position-relative mt-sm-5" style="top: 1.7rem;">
                    <img src="{{ asset('img/generic/generic-corporate-3-1.png') }}" class="img-fluid position-absolute d-none d-sm-block appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="300" style="top: 10%; left: -50%;" alt="" />
                    <img src="{{ asset('img/generic/generic-corporate-3-2.png') }}" class="img-fluid position-absolute d-none d-sm-block appear-animation" data-appear-animation="expandIn" style="top: -33%; left: -29%;" alt="" />
                    <img src="{{ asset('img/generic/generic-corporate-3-3.png') }}" class="img-fluid position-relative appear-animation mb-2" data-appear-animation="expandIn" data-appear-animation-delay="600" alt="" />
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="get-started text-start text-lg-end">
                        <a href="{{ route('features.consult') }}" class="btn btn-dark btn-lg text-3 font-weight-semibold px-4 py-3">Book a
                            Consultation</a>
...
<section class="section section-height-3 border-0 mt-0 mb-0">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="{{ route('about.founder') }}" class="btn btn-dark font-weight-semibold rounded-0 px-5 btn-py-2 text-2 p-relative bottom-3">Read
    ...
    <div class="container">
        <div class="row justify-content-center recent-posts appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
            ...
            <div class="text-center">
                <div class="col">
                    <h2 class="font-weight-normal text-6 mt-4">Latest <strong class="font-weight-extra-bold">Blog</strong></h2>
                </div>
            </div>
            <?php
                    ...
                    <div class="post-content">
                        ...
                        <div class="post-meta">
                            <span class="d-block mt-2">
                                <a href="{{ route('newssingle', $blog->uuid) }}" class="btn btn-xs btn-light text-1 text-uppercase">Read More</a>
                            </span>
                        </div>
                    </div>
                    </article>
