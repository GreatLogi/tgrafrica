            ...
            <div class="modal-body custom-modal-body">
                <form id="questionnaireForm" action="{{ route('submit-questionnaire') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="question{{ $index }}" name="question{{ $index }}" required>
                            @for ($i = 1; $i <= 10; $i++)
                    ...
                    <div class="mb-3 date-time-container">
                        <label for="time" class="form-label">Preferred Date and Time (Please key in your preferred time at your location).</label>
                        <input type="datetime-local" class="form-control modern-date-time" id="time" name="response_time_and_date" placeholder="Select date and time" required>
                    </div>
