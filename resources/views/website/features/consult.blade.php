            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="questionnaireForm" action="{{ route('submit-questionnaire') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="time" class="form-label">Preferred Time (Please Key in your prefered time at
                                your location.)</label>
                            <input type="time" class="form-control" id="time" name="response_time" required>
                        </div>
